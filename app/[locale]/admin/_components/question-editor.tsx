...
export function QuestionEditor({ qaId }: QuestionEditorProps) {
  ...
  useEffect(() => {
    if (!isNew && qaDoc) {
      ...
      setFormData({
        ...
        sectionId: qaDoc.section_number
          ? (sectionsList.find(
              (s) => s.order.toString() === qaDoc.section_number
            )?._id ?? "")
          : "",
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true);
    try {
      const selectedSection = formData.sectionId
        ? sectionsMap.get(formData.sectionId as any)
        : null;
      ...
      await saveQA({
        id: (isNew ? undefined : qaId) as Id<"qa"> | undefined,
        ...
        section_number: selectedSection
          ? selectedSection.order.toString()
          : undefined,
        ...
        <div className="space-y-8 lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                The core question and answer content.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Textarea
                  className="min-h-[100px] resize-y font-medium text-lg"
                  onChange={(e) =>
              ...
              <div className="space-y-2">
                ...
                <div className="min-h-[400px] rounded-md border focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
                  <RichTextEditor
                    onChange={({ raw }) =>
                      setFormData((p) => ({ ...p, answerRich: raw }))
                    }
