...
export const logSearchError = (context: SearchErrorContext): void => {
  ...
  console.error(
    `Search type: ${context.searchType}, Latency: ${context.latencyMs}ms`
  );
 ...
 */
export const sanitizeContentForEmbedding = (
  question: string,
  answer: string
) => {
 ...
 */
export const getEmbeddingCacheKey = (
  question: string,
  answer: string,
...
export const filterQuestions = (
  ...
  return questions.filter((question) => {
    ...
    if (
      ...
      !filters.sections.includes(question.section_number)
    ) {
      return false;
    }
...
export const validateQuestion = (
  question: QuestionWithEmbeddingStatus
): {
  valid: boolean;
  error?: string;
} => {
